...
from services.core.wiring import build_default_job_command_port

# --- Configuration ---
DEBUG_MODE = os.environ.get('CLIP_DEBUG', '0') == '1'
BACKEND_PORT = int(os.environ.get('CLIP_BACKEND_PORT', '8011'))
...
app.state.job_commands = build_default_job_command_port()
